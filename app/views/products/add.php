        ...
        <div class="row">
            <div class="col-md-9 mx-auto">
                <div class="card bg-light">
                    <div class="card-header bg-secondary">Add Product</div>
                    <div class="card-body">
                        <form action="<?php echo URLROOT;?>/products/create" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" 
                                                  cols="30" rows="5" class="form-control form-control-sm"><?php echo $data['description'];?></textarea>
                                    </div>
                                </div>
