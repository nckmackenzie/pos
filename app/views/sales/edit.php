                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="sdate" id="sdate" class="form-control form-control-sm" 
                               value="<?php echo $data['sale']->SaleDate;?>"       
                               required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="customer" id="customer" class="form-control form-control-sm" required>
                            ...
                            <?php foreach($data['customers'] as $customer) : ?>
                                <option value="<?php echo $customer->ID;?>" <?php selectdCheck($data['sale']->CustomerID,$customer->ID)?>>
                                <?php echo $customer->CustomerName;?></option>
                            <?php endforeach;?>
                        </select>
                        <input type="hidden" name="id" value="<?php echo $data['sale']->ID;?>">
                    </div>
                </div>
                    ...
                    <table class="table table-sm table-bordered table-stripped" id="salesTable">
                        ...
                        <tbody id="tbody">
                            <?php foreach($data['details'] as $detail) : ?>
                                <tr>
                                    <td>
                                        <select name="product[]" class="form-control form-control-sm select2 prodedit">
                                            <option value="0" disabled selected>Select Product</option>
                                            <?php foreach($data['products'] as $product) : ?>
                                                            <option value="<?php echo $product->ID;?>" 
                                                            <?php selectdCheck($detail->ProductID,$product->ID) ?>>
                                                            <?php echo $product->ProductName;?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                    <td>
                                        <input name="stock" type="text" class="form-control form-control-sm stock" 
                                               value="<?php echo $detail->Stock;?>" readonly>
                                    </td>
                                    <td>
                                        <input name="qty[]" type="number" class="form-control form-control-sm qty" 
                                               value="<?php echo $detail->Qty;?>">
                                    </td>
                                    <td>
                                        <input name="rate[]" type="text" class="form-control form-control-sm rate"
                                               value="<?php echo str_replace(',','',$detail->Rate);?>"
                                               readonly>
                                    </td>
                                    <td>
                                        <input name="value[]" type="text" class="form-control form-control-sm value" 
                                               value="<?php echo $detail->SellingValue;?>" readonly>
                                    </td>
                                    <td>
                                        <center><button type="button" class="btn btn-sm btn-danger btnremove"><i class="bi bi-trash"></i></button></center>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="subtotald" id="subtotald" 
                                    class="form-control form-control-sm" value="<?php echo number_format($data['sale']->SubTotal,2);?>" readonly>
                                <input type="hidden" name="subtotal" id="subtotal" value="<?php echo $data['sale']->SubTotal;?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control form-control-sm" id="discount" name="discount"
                                           value="<?php echo $data['sale']->Discount;?>"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="totald" id="totald"
                                    ...
                                    value="<?php echo number_format($data['sale']->TotalAmount);?>"
                                    readonly>
                                <input type="hidden" name="total" id="total" value="<?php echo $data['sale']->TotalAmount;?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="paid" id="paid" 
                                    class="form-control form-control-sm"
                                    value="<?php echo $data['sale']->AmountPaid;?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="dued" id="dued" 
                                    class="form-control form-control-sm" 
                                    value="<?php echo number_format($data['sale']->Balance,2);?>"
                                    readonly>
                                <input type="hidden" name="due" id="due" value="<?php echo $data['sale']->Balance;?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function(){
        ...
        $(document).ready(function(){
            ...
            $('#salesTable').on('change','.prodedit' , function(){
        ...
        $('#salesTable').on('change','.prod' , function(){
            ...
            if (Number(rowCount) > 1) {
                var table =$('#salesTable');
                var check_value = $(table).find(".prodedit").val();
