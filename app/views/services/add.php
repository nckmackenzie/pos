        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card bg-light">
                    <div class="card-header bg-secondary">Add Service</div>
                        <div class="card-body">
                            <form action="<?php echo URLROOT;?>/services/create" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="service" id="service" 
                                            ...
                                            <?php foreach($data['services'] as $service) : ?>
                                                <option value="<?php echo $service->ID;?>"><?php echo strtoupper($service->Service);?></option>
                                            <?php endforeach; ?>    
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="customer" id="customer" 
                                            ...
                                            <?php foreach($data['customers'] as $customer) : ?>
                                                <option value="<?php echo $customer->ID;?>"><?php echo strtoupper($customer->CustomerName);?></option>
                                            <?php endforeach; ?>    
                                        </select>
