...
<?php require APPROOT . '/views/inc/sidenav.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="<?php echo URLROOT;?>/receipts/update" method="post">
          <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="ref">Receipt Reference</label>
                        <input type="text" id="ref" class="form-control form-control-sm" name="ref" 
                              value="<?php echo $data['header']->Reference;?>" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="date">Receipt Date</label>
                        <input type="date" name="date" id="idate" class="form-control form-control-sm"
                               value="<?php echo $data['header']->ReceiptDate;?>"
                        required>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="supplier" id="supplier" class="form-control form-control-sm" required>
                            <?php foreach($data['suppliers'] as $supplier) : ?>
                                ...
                                <?php selectdCheck($data['header']->SupplierID,$supplier->ID)?>><?php echo $supplier->SupplierName;?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
