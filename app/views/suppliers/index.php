  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <a href="<?php echo URLROOT;?>/suppliers/add" class="btn btn-sm bg-custom text-white">Add New</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                    ...
                    <tbody>
                        <?php foreach($data['suppliers'] as $supplier) :?>
                            <tr>
                                ...
                                <td><?php echo strtoupper($supplier->PIN);?></td>
...
<script>
    $(function(){
      ...
      $('#suppliersTable').on('click','.btndel',function(){
          ...
          var data1 = $('#suppliersTable').DataTable().row(currentRow).data();
          $('#id').val(data1[0]);
      });
    });
</script>
