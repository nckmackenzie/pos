    ...
    <section class="content">
        <div class="row col-md-8 mx-auto">
            <div class="card bg-light">
                <div class="card-header bg-secondary">Add Supplier</div>
                <div class="card-body">
                    <form action="<?php echo URLROOT;?>/suppliers/create" method="post">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact" 
                                           ...
                                           value="<?php echo $data['contact'];?>" autocomplete="off">
